...
namespace OpenCVForUnityExample
{
    ...
    public class FaceDetectionYuNetExample : DnnObjectDetectionWebCamTextureExample
    {
        ...
        public Point position_right_eye;
        public Point position_left_eye;
        public Point position_nose;
        public Point position_right_mouth;
        public Point position_left_mouth;
        ...
        protected override void Update()
        {
            if (webCamTextureToMatHelper.IsPlaying() && webCamTextureToMatHelper.DidUpdateThisFrame())
            {
                ...
                // Debug.Log("righteye: " + position_right_eye);
            }
        }
        ...
        protected virtual void drawPredPoints(Point[] points, Mat frame)
        {
            ...
            // Debug.Log("the right eye is " + points[0]);
            //    Debug.Log("the left eye is " + points[1]);
            //    Debug.Log("the nose eye is " + points[2]);
            //    Debug.Log("the right mouth is " + points[3]);
            //    Debug.Log("the left mouth is " + points[4]);

            position_right_eye = points[0];
            position_left_eye = points[1];
            position_nose = points[2];
            position_right_mouth = points[3];
            position_left_mouth = points[4];
